var iceGame = new Phaser.Class({
    ...
    preload: function() {
        ...
        this.load.image("ground2", "https://raw.githubusercontent.com/Pieternauw/ULS-Inc/508c262fcaf54d4bfd4fdb4b6adfbd7296ac3649/Game%20V2/src/resources/dungeon/ice_brick.png");
    ...
    create: function() {
        ...
        { //top left room (1,1)
            //floor
            platforms.create(0, 650, "ground2").setScale(0.4).refreshBody();
            ...
            platforms.create(675, 650, "ground2").setScale(0.4).refreshBody();
            platforms.create(750, 650, "ground2").setScale(0.4).refreshBody();
            //left side (done)
            platforms.create(0, 0, "ground2").setScale(0.4).refreshBody();
            platforms.create(0, 75, "ground2").setScale(0.4).refreshBody();
            platforms.create(0, 150, "ground2").setScale(0.4).refreshBody();
            platforms.create(0, 225, "ground2").setScale(0.4).refreshBody();
            platforms.create(0, 275, "ground2").setScale(0.4).refreshBody();
            platforms.create(0, 350, "ground2").setScale(0.4).refreshBody();
            platforms.create(0, 400, "ground2").setScale(0.4).refreshBody();
            platforms.create(0, 450, "ground2").setScale(0.4).refreshBody();
            platforms.create(0, 525, "ground2").setScale(0.4).refreshBody();
            platforms.create(0, 600, "ground2").setScale(0.4).refreshBody();
            platforms.create(0, 675, "ground2").setScale(0.4).refreshBody();
            //top side (done)
            platforms.create(75, 0, "ground2").setScale(0.4).refreshBody();
            platforms.create(150, 0, "ground2").setScale(0.4).refreshBody();
            platforms.create(225, 0, "ground2").setScale(0.4).refreshBody();
            platforms.create(300, 0, "ground2").setScale(0.4).refreshBody();
            platforms.create(375, 0, "ground2").setScale(0.4).refreshBody();
            platforms.create(425, 0, "ground2").setScale(0.4).refreshBody();
            platforms.create(475, 0, "ground2").setScale(0.4).refreshBody();
            platforms.create(525, 0, "ground2").setScale(0.4).refreshBody();
            platforms.create(600, 0, "ground2").setScale(0.4).refreshBody();
            platforms.create(675, 0, "ground2").setScale(0.4).refreshBody();
            platforms.create(750, 0, "ground2").setScale(0.4).refreshBody();
            //right side (done)
            platforms.create(800, 0, "ground2").setScale(0.4).refreshBody();
            platforms.create(800, 75, "ground2").setScale(0.4).refreshBody();
            platforms.create(800, 150, "ground2").setScale(0.4).refreshBody();
            platforms.create(800, 225, "ground2").setScale(0.4).refreshBody();
            platforms.create(800, 275, "ground2").setScale(0.4).refreshBody();
            platforms.create(800, 450, "ground2").setScale(0.4).refreshBody();
            platforms.create(800, 525, "ground2").setScale(0.4).refreshBody();
            platforms.create(800, 600, "ground2").setScale(0.4).refreshBody();
            platforms.create(800, 675, "ground2").setScale(0.4).refreshBody();
            //top middle room #1 (2,1)
            //floor
            platforms.create(800, 650, "ground2").setScale(0.4).refreshBody();
            platforms.create(875, 650, "ground2").setScale(0.4).refreshBody();
            platforms.create(950, 650, "ground2").setScale(0.4).refreshBody();
            ...
            platforms.create(1475, 650, "ground2").setScale(0.4).refreshBody();
            platforms.create(1550, 650, "ground2").setScale(0.4).refreshBody();
            //top side (done)
            platforms.create(875, 0, "ground2").setScale(0.4).refreshBody();
            platforms.create(950, 0, "ground2").setScale(0.4).refreshBody();
            platforms.create(1025, 0, "ground2").setScale(0.4).refreshBody();
            platforms.create(1100, 0, "ground2").setScale(0.4).refreshBody();
            platforms.create(1175, 0, "ground2").setScale(0.4).refreshBody();
            platforms.create(1225, 0, "ground2").setScale(0.4).refreshBody();
            platforms.create(1275, 0, "ground2").setScale(0.4).refreshBody();
            platforms.create(1325, 0, "ground2").setScale(0.4).refreshBody();
            platforms.create(1400, 0, "ground2").setScale(0.4).refreshBody();
            platforms.create(1475, 0, "ground2").setScale(0.4).refreshBody();
            platforms.create(1550, 0, "ground2").setScale(0.4).refreshBody();
            //right side (done)
            platforms.create(1600, 0, "ground2").setScale(0.4).refreshBody();
            platforms.create(1600, 75, "ground2").setScale(0.4).refreshBody();
            platforms.create(1600, 150, "ground2").setScale(0.4).refreshBody();
            platforms.create(1600, 225, "ground2").setScale(0.4).refreshBody();
            platforms.create(1600, 275, "ground2").setScale(0.4).refreshBody();
            platforms.create(1600, 450, "ground2").setScale(0.4).refreshBody();
            platforms.create(1600, 525, "ground2").setScale(0.4).refreshBody();
            platforms.create(1600, 600, "ground2").setScale(0.4).refreshBody();
            platforms.create(1600, 675, "ground2").setScale(0.4).refreshBody();
            //top middle room #2 (3,1)
            //floor
            platforms.create(1600, 650, "ground2").setScale(0.4).refreshBody();
            platforms.create(1675, 650, "ground2").setScale(0.4).refreshBody();
            ...
            platforms.create(2275, 650, "ground2").setScale(0.4).refreshBody();
            platforms.create(2350, 650, "ground2").setScale(0.4).refreshBody();
            //top side (done)
            platforms.create(1675, 0, "ground2").setScale(0.4).refreshBody();
            platforms.create(1750, 0, "ground2").setScale(0.4).refreshBody();
            platforms.create(1825, 0, "ground2").setScale(0.4).refreshBody();
            platforms.create(1900, 0, "ground2").setScale(0.4).refreshBody();
            platforms.create(1975, 0, "ground2").setScale(0.4).refreshBody();
            platforms.create(2025, 0, "ground2").setScale(0.4).refreshBody();
            platforms.create(2075, 0, "ground2").setScale(0.4).refreshBody();
            platforms.create(2125, 0, "ground2").setScale(0.4).refreshBody();
            platforms.create(2200, 0, "ground2").setScale(0.4).refreshBody();
            platforms.create(2275, 0, "ground2").setScale(0.4).refreshBody();
            platforms.create(2350, 0, "ground2").setScale(0.4).refreshBody();
            //right side (done)
            platforms.create(2400, 0, "ground2").setScale(0.4).refreshBody();
            platforms.create(2400, 75, "ground2").setScale(0.4).refreshBody();
            platforms.create(2400, 150, "ground2").setScale(0.4).refreshBody();
            platforms.create(2400, 225, "ground2").setScale(0.4).refreshBody();
            platforms.create(2400, 275, "ground2").setScale(0.4).refreshBody();
            platforms.create(2400, 325, "ground2").setScale(0.4).refreshBody();
            platforms.create(2400, 400, "ground2").setScale(0.4).refreshBody();
            platforms.create(2400, 450, "ground2").setScale(0.4).refreshBody();
            platforms.create(2400, 525, "ground2").setScale(0.4).refreshBody();
            platforms.create(2400, 600, "ground2").setScale(0.4).refreshBody();
            platforms.create(2400, 675, "ground2").setScale(0.4).refreshBody();
            //top middle room #3 (4,1)
            //floor
            platforms.create(2400, 650, "ground2").setScale(0.4).refreshBody();
            platforms.create(2475, 650, "ground2").setScale(0.4).refreshBody();
            platforms.create(2550, 650, "ground2").setScale(0.4).refreshBody();
            platforms.create(2625, 650, "ground2").setScale(0.4).refreshBody();
            platforms.create(2700, 650, "ground2").setScale(0.4).refreshBody();
            platforms.create(2875, 650, "ground2").setScale(0.4).refreshBody();
            platforms.create(2925, 650, "ground2").setScale(0.4).refreshBody();
            platforms.create(3000, 650, "ground2").setScale(0.4).refreshBody();
            platforms.create(3075, 650, "ground2").setScale(0.4).refreshBody();
            platforms.create(3150, 650, "ground2").setScale(0.4).refreshBody();
            //top side (done)
            platforms.create(2475, 0, "ground2").setScale(0.4).refreshBody();
            platforms.create(2550, 0, "ground2").setScale(0.4).refreshBody();
            platforms.create(2625, 0, "ground2").setScale(0.4).refreshBody();
            platforms.create(2700, 0, "ground2").setScale(0.4).refreshBody();
            platforms.create(2775, 0, "ground2").setScale(0.4).refreshBody();
            platforms.create(2825, 0, "ground2").setScale(0.4).refreshBody();
            platforms.create(2875, 0, "ground2").setScale(0.4).refreshBody();
            platforms.create(2925, 0, "ground2").setScale(0.4).refreshBody();
            platforms.create(3000, 0, "ground2").setScale(0.4).refreshBody();
            platforms.create(3075, 0, "ground2").setScale(0.4).refreshBody();
            platforms.create(3150, 0, "ground2").setScale(0.4).refreshBody();
            //right side (done)
            platforms.create(3200, 0, "ground2").setScale(0.4).refreshBody();
            platforms.create(3200, 75, "ground2").setScale(0.4).refreshBody();
            platforms.create(3200, 150, "ground2").setScale(0.4).refreshBody();
            platforms.create(3200, 225, "ground2").setScale(0.4).refreshBody();
            platforms.create(3200, 275, "ground2").setScale(0.4).refreshBody();
            platforms.create(3200, 325, "ground2").setScale(0.4).refreshBody();
            platforms.create(3200, 400, "ground2").setScale(0.4).refreshBody();
            platforms.create(3200, 450, "ground2").setScale(0.4).refreshBody();
            platforms.create(3200, 525, "ground2").setScale(0.4).refreshBody();
            platforms.create(3200, 600, "ground2").setScale(0.4).refreshBody();
            platforms.create(3200, 675, "ground2").setScale(0.4).refreshBody();
            //right top room (5,1)
            //floor
            platforms.create(3200, 650, "ground2").setScale(0.4).refreshBody();
            platforms.create(3275, 650, "ground2").setScale(0.4).refreshBody();
            platforms.create(3350, 650, "ground2").setScale(0.4).refreshBody();
            platforms.create(3425, 650, "ground2").setScale(0.4).refreshBody();
            platforms.create(3500, 650, "ground2").setScale(0.4).refreshBody();
            platforms.create(3675, 650, "ground2").setScale(0.4).refreshBody();
            platforms.create(3725, 650, "ground2").setScale(0.4).refreshBody();
            platforms.create(3800, 650, "ground2").setScale(0.4).refreshBody();
            platforms.create(3875, 650, "ground2").setScale(0.4).refreshBody();
            platforms.create(3950, 650, "ground2").setScale(0.4).refreshBody();
            //top side (done)
            platforms.create(3275, 0, "ground2").setScale(0.4).refreshBody();
            platforms.create(3350, 0, "ground2").setScale(0.4).refreshBody();
            platforms.create(3425, 0, "ground2").setScale(0.4).refreshBody();
            platforms.create(3500, 0, "ground2").setScale(0.4).refreshBody();
            platforms.create(3575, 0, "ground2").setScale(0.4).refreshBody();
            platforms.create(3625, 0, "ground2").setScale(0.4).refreshBody();
            platforms.create(3675, 0, "ground2").setScale(0.4).refreshBody();
            platforms.create(3725, 0, "ground2").setScale(0.4).refreshBody();
            platforms.create(3800, 0, "ground2").setScale(0.4).refreshBody();
            platforms.create(3875, 0, "ground2").setScale(0.4).refreshBody();
            platforms.create(3950, 0, "ground2").setScale(0.4).refreshBody();
            //right side (done)
            platforms.create(4000, 0, "ground2").setScale(0.4).refreshBody();
            platforms.create(4000, 75, "ground2").setScale(0.4).refreshBody();
            platforms.create(4000, 150, "ground2").setScale(0.4).refreshBody();
            platforms.create(4000, 225, "ground2").setScale(0.4).refreshBody();
            platforms.create(4000, 275, "ground2").setScale(0.4).refreshBody();
            platforms.create(4000, 325, "ground2").setScale(0.4).refreshBody();
            platforms.create(4000, 400, "ground2").setScale(0.4).refreshBody();
            platforms.create(4000, 450, "ground2").setScale(0.4).refreshBody();
            platforms.create(4000, 525, "ground2").setScale(0.4).refreshBody();
            platforms.create(4000, 600, "ground2").setScale(0.4).refreshBody();
            platforms.create(4000, 675, "ground2").setScale(0.4).refreshBody();
            //left side room #1 (1,2)
            //floor
            platforms.create(0, 1300, "ground2").setScale(0.4).refreshBody();
            platforms.create(75, 1300, "ground2").setScale(0.4).refreshBody();
            platforms.create(150, 1300, "ground2").setScale(0.4).refreshBody();
            platforms.create(225, 1300, "ground2").setScale(0.4).refreshBody();
            platforms.create(300, 1300, "ground2").setScale(0.4).refreshBody();
            platforms.create(475, 1300, "ground2").setScale(0.4).refreshBody();
            platforms.create(525, 1300, "ground2").setScale(0.4).refreshBody();
            platforms.create(600, 1300, "ground2").setScale(0.4).refreshBody();
            platforms.create(675, 1300, "ground2").setScale(0.4).refreshBody();
            platforms.create(750, 1300, "ground2").setScale(0.4).refreshBody();
            //left side (done)
            platforms.create(0, 650, "ground2").setScale(0.4).refreshBody();
            platforms.create(0, 725, "ground2").setScale(0.4).refreshBody();
            platforms.create(0, 800, "ground2").setScale(0.4).refreshBody();
            platforms.create(0, 875, "ground2").setScale(0.4).refreshBody();
            platforms.create(0, 925, "ground2").setScale(0.4).refreshBody();
            platforms.create(0, 1000, "ground2").setScale(0.4).refreshBody();
            platforms.create(0, 1050, "ground2").setScale(0.4).refreshBody();
            platforms.create(0, 1100, "ground2").setScale(0.4).refreshBody();
            platforms.create(0, 1175, "ground2").setScale(0.4).refreshBody();
            platforms.create(0, 1250, "ground2").setScale(0.4).refreshBody();
            platforms.create(0, 1325, "ground2").setScale(0.4).refreshBody();
            //right side (done)
            platforms.create(800, 650, "ground2").setScale(0.4).refreshBody();
            platforms.create(800, 725, "ground2").setScale(0.4).refreshBody();
            platforms.create(800, 800, "ground2").setScale(0.4).refreshBody();
            platforms.create(800, 875, "ground2").setScale(0.4).refreshBody();
            platforms.create(800, 925, "ground2").setScale(0.4).refreshBody();
            platforms.create(800, 1000, "ground2").setScale(0.4).refreshBody();
            platforms.create(800, 1050, "ground2").setScale(0.4).refreshBody();
            platforms.create(800, 1100, "ground2").setScale(0.4).refreshBody();
            platforms.create(800, 1175, "ground2").setScale(0.4).refreshBody();
            platforms.create(800, 1250, "ground2").setScale(0.4).refreshBody();
            platforms.create(800, 1325, "ground2").setScale(0.4).refreshBody();
            //left side room #2 (1,3)
            //floor
            platforms.create(0, 1950, "ground2").setScale(0.4).refreshBody();
            ...
            platforms.create(675, 1950, "ground2").setScale(0.4).refreshBody();
            platforms.create(750, 1950, "ground2").setScale(0.4).refreshBody();
            //left side (done)
            platforms.create(0, 1300, "ground2").setScale(0.4).refreshBody();
            platforms.create(0, 1375, "ground2").setScale(0.4).refreshBody();
            platforms.create(0, 1450, "ground2").setScale(0.4).refreshBody();
            platforms.create(0, 1525, "ground2").setScale(0.4).refreshBody();
            platforms.create(0, 1575, "ground2").setScale(0.4).refreshBody();
            platforms.create(0, 1650, "ground2").setScale(0.4).refreshBody();
            platforms.create(0, 1700, "ground2").setScale(0.4).refreshBody();
            platforms.create(0, 1750, "ground2").setScale(0.4).refreshBody();
            platforms.create(0, 1825, "ground2").setScale(0.4).refreshBody();
            platforms.create(0, 1900, "ground2").setScale(0.4).refreshBody();
            platforms.create(0, 1975, "ground2").setScale(0.4).refreshBody();
            //right side (done)
            platforms.create(800, 1300, "ground2").setScale(0.4).refreshBody();
            platforms.create(800, 1375, "ground2").setScale(0.4).refreshBody();
            platforms.create(800, 1450, "ground2").setScale(0.4).refreshBody();
            platforms.create(800, 1525, "ground2").setScale(0.4).refreshBody();
            platforms.create(800, 1575, "ground2").setScale(0.4).refreshBody();
            platforms.create(800, 1750, "ground2").setScale(0.4).refreshBody();
            platforms.create(800, 1825, "ground2").setScale(0.4).refreshBody();
            platforms.create(800, 1900, "ground2").setScale(0.4).refreshBody();
            platforms.create(800, 1975, "ground2").setScale(0.4).refreshBody();
            //left side room #3 (1,4)
            //floor
            platforms.create(0, 2600, "ground2").setScale(0.4).refreshBody();
            platforms.create(75, 2600, "ground2").setScale(0.4).refreshBody();
            platforms.create(150, 2600, "ground2").setScale(0.4).refreshBody();
            ...
            platforms.create(675, 2600, "ground2").setScale(0.4).refreshBody();
            platforms.create(750, 2600, "ground2").setScale(0.4).refreshBody();
            //left side (done)
            platforms.create(0, 1950, "ground2").setScale(0.4).refreshBody();
            platforms.create(0, 2025, "ground2").setScale(0.4).refreshBody();
            platforms.create(0, 2100, "ground2").setScale(0.4).refreshBody();
            platforms.create(0, 2175, "ground2").setScale(0.4).refreshBody();
            platforms.create(0, 2225, "ground2").setScale(0.4).refreshBody();
            platforms.create(0, 2300, "ground2").setScale(0.4).refreshBody();
            platforms.create(0, 2350, "ground2").setScale(0.4).refreshBody();
            platforms.create(0, 2400, "ground2").setScale(0.4).refreshBody();
            platforms.create(0, 2475, "ground2").setScale(0.4).refreshBody();
            platforms.create(0, 2550, "ground2").setScale(0.4).refreshBody();
            platforms.create(0, 2625, "ground2").setScale(0.4).refreshBody();
            //right side (done)
            platforms.create(800, 1950, "ground2").setScale(0.4).refreshBody();
            platforms.create(800, 2025, "ground2").setScale(0.4).refreshBody();
            platforms.create(800, 2100, "ground2").setScale(0.4).refreshBody();
            platforms.create(800, 2175, "ground2").setScale(0.4).refreshBody();
            platforms.create(800, 2225, "ground2").setScale(0.4).refreshBody();
            platforms.create(800, 2300, "ground2").setScale(0.4).refreshBody();
            platforms.create(800, 2350, "ground2").setScale(0.4).refreshBody();
            platforms.create(800, 2400, "ground2").setScale(0.4).refreshBody();
            platforms.create(800, 2475, "ground2").setScale(0.4).refreshBody();
            platforms.create(800, 2550, "ground2").setScale(0.4).refreshBody();
            platforms.create(800, 2625, "ground2").setScale(0.4).refreshBody();
            //bottom left corner room (1,5)
            //floor
            platforms.create(0, 3250, "ground2").setScale(0.4).refreshBody();
            platforms.create(75, 3250, "ground2").setScale(0.4).refreshBody();
            platforms.create(150, 3250, "ground2").setScale(0.4).refreshBody();
            ...
            platforms.create(675, 3250, "ground2").setScale(0.4).refreshBody();
            platforms.create(750, 3250, "ground2").setScale(0.4).refreshBody();
            //left side (done)
            platforms.create(0, 2600, "ground2").setScale(0.4).refreshBody();
            platforms.create(0, 2675, "ground2").setScale(0.4).refreshBody();
            platforms.create(0, 2750, "ground2").setScale(0.4).refreshBody();
            platforms.create(0, 2825, "ground2").setScale(0.4).refreshBody();
            platforms.create(0, 2875, "ground2").setScale(0.4).refreshBody();
            platforms.create(0, 2950, "ground2").setScale(0.4).refreshBody();
            platforms.create(0, 3000, "ground2").setScale(0.4).refreshBody();
            platforms.create(0, 3050, "ground2").setScale(0.4).refreshBody();
            platforms.create(0, 3125, "ground2").setScale(0.4).refreshBody();
            platforms.create(0, 3200, "ground2").setScale(0.4).refreshBody();
            platforms.create(0, 3250, "ground2").setScale(0.4).refreshBody();
            //right side (done)
            platforms.create(800, 2600, "ground2").setScale(0.4).refreshBody();
            platforms.create(800, 2675, "ground2").setScale(0.4).refreshBody();
            platforms.create(800, 2750, "ground2").setScale(0.4).refreshBody();
            platforms.create(800, 2825, "ground2").setScale(0.4).refreshBody();
            platforms.create(800, 2875, "ground2").setScale(0.4).refreshBody();
            platforms.create(800, 3050, "ground2").setScale(0.4).refreshBody();
            platforms.create(800, 3125, "ground2").setScale(0.4).refreshBody();
            platforms.create(800, 3200, "ground2").setScale(0.4).refreshBody();
            platforms.create(800, 3250, "ground2").setScale(0.4).refreshBody();
            //bottom middle room #1 (start of bottom) (2,5)
            //floor
            platforms.create(800, 3250, "ground2").setScale(0.4).refreshBody();
            platforms.create(875, 3250, "ground2").setScale(0.4).refreshBody();
            ...
            platforms.create(1475, 3250, "ground2").setScale(0.4).refreshBody();
            platforms.create(1550, 3250, "ground2").setScale(0.4).refreshBody();
            //right side (done)
            platforms.create(2400, 2600, "ground2").setScale(0.4).refreshBody();
            platforms.create(2400, 2675, "ground2").setScale(0.4).refreshBody();
            platforms.create(2400, 2750, "ground2").setScale(0.4).refreshBody();
            platforms.create(2400, 2825, "ground2").setScale(0.4).refreshBody();
            platforms.create(2400, 2875, "ground2").setScale(0.4).refreshBody();
            platforms.create(2400, 2925, "ground2").setScale(0.4).refreshBody();
            platforms.create(2400, 3000, "ground2").setScale(0.4).refreshBody();
            platforms.create(2400, 3050, "ground2").setScale(0.4).refreshBody();
            platforms.create(2400, 3125, "ground2").setScale(0.4).refreshBody();
            platforms.create(2400, 3200, "ground2").setScale(0.4).refreshBody();
            platforms.create(2400, 3250, "ground2").setScale(0.4).refreshBody();
            //bottom middle room #2 (3,5)
            //floor
            platforms.create(1600, 3250, "ground2").setScale(0.4).refreshBody();
            platforms.create(1675, 3250, "ground2").setScale(0.4).refreshBody();
            platforms.create(1750, 3250, "ground2").setScale(0.4).refreshBody();
            platforms.create(1825, 3250, "ground2").setScale(0.4).refreshBody();
            platforms.create(1900, 3250, "ground2").setScale(0.4).refreshBody();
            platforms.create(1975, 3250, "ground2").setScale(0.4).refreshBody();
            platforms.create(2000, 3250, "ground2").setScale(0.4).refreshBody();
            platforms.create(2075, 3250, "ground2").setScale(0.4).refreshBody();
            platforms.create(2125, 3250, "ground2").setScale(0.4).refreshBody();
            platforms.create(2200, 3250, "ground2").setScale(0.4).refreshBody();
            platforms.create(2275, 3250, "ground2").setScale(0.4).refreshBody();
            platforms.create(2350, 3250, "ground2").setScale(0.4).refreshBody();
            //right side (done)
            platforms.create(1600, 2600, "ground2").setScale(0.4).refreshBody();
            platforms.create(1600, 2675, "ground2").setScale(0.4).refreshBody();
            platforms.create(1600, 2750, "ground2").setScale(0.4).refreshBody();
            platforms.create(1600, 2825, "ground2").setScale(0.4).refreshBody();
            platforms.create(1600, 2875, "ground2").setScale(0.4).refreshBody();
            platforms.create(1600, 2925, "ground2").setScale(0.4).refreshBody();
            platforms.create(1600, 3000, "ground2").setScale(0.4).refreshBody();
            platforms.create(1600, 3050, "ground2").setScale(0.4).refreshBody();
            platforms.create(1600, 3125, "ground2").setScale(0.4).refreshBody();
            platforms.create(1600, 3200, "ground2").setScale(0.4).refreshBody();
            platforms.create(1600, 3250, "ground2").setScale(0.4).refreshBody();
            //bottom middle room #3 (4,5)
            //floor
            platforms.create(2400, 3250, "ground2").setScale(0.4).refreshBody();
            platforms.create(2475, 3250, "ground2").setScale(0.4).refreshBody();
            ...
            platforms.create(3075, 3250, "ground2").setScale(0.4).refreshBody();
            platforms.create(3150, 3250, "ground2").setScale(0.4).refreshBody();
            //right side (done)
            platforms.create(3200, 2600, "ground2").setScale(0.4).refreshBody();
            platforms.create(3200, 2675, "ground2").setScale(0.4).refreshBody();
            platforms.create(3200, 2750, "ground2").setScale(0.4).refreshBody();
            platforms.create(3200, 2825, "ground2").setScale(0.4).refreshBody();
            platforms.create(3200, 2875, "ground2").setScale(0.4).refreshBody();
            platforms.create(3200, 2950, "ground2").setScale(0.4).refreshBody();
            platforms.create(3200, 3000, "ground2").setScale(0.4).refreshBody();
            platforms.create(3200, 3050, "ground2").setScale(0.4).refreshBody();
            platforms.create(3200, 3125, "ground2").setScale(0.4).refreshBody();
            platforms.create(3200, 3200, "ground2").setScale(0.4).refreshBody();
            platforms.create(3200, 3250, "ground2").setScale(0.4).refreshBody();
            //right bottom room (5,5)
            //floor
            platforms.create(3200, 3250, "ground2").setScale(0.4).refreshBody();
            platforms.create(3275, 3250, "ground2").setScale(0.4).refreshBody();
            platforms.create(3350, 3250, "ground2").setScale(0.4).refreshBody();
            ...
            platforms.create(3875, 3250, "ground2").setScale(0.4).refreshBody();
            platforms.create(3950, 3250, "ground2").setScale(0.4).refreshBody();
            //right side (done)
            platforms.create(4000, 2600, "ground2").setScale(0.4).refreshBody();
            platforms.create(4000, 2675, "ground2").setScale(0.4).refreshBody();
            platforms.create(4000, 2750, "ground2").setScale(0.4).refreshBody();
            platforms.create(4000, 2825, "ground2").setScale(0.4).refreshBody();
            platforms.create(4000, 2875, "ground2").setScale(0.4).refreshBody();
            platforms.create(4000, 2925, "ground2").setScale(0.4).refreshBody();
            platforms.create(4000, 3000, "ground2").setScale(0.4).refreshBody();
            platforms.create(4000, 3050, "ground2").setScale(0.4).refreshBody();
            platforms.create(4000, 3125, "ground2").setScale(0.4).refreshBody();
            platforms.create(4000, 3200, "ground2").setScale(0.4).refreshBody();
            platforms.create(4000, 3250, "ground2").setScale(0.4).refreshBody();
            //(start of right side rooms)
            //right side room #1 (5,2)
            //floor
            platforms.create(3200, 1300, "ground2").setScale(0.4).refreshBody();
            platforms.create(3275, 1300, "ground2").setScale(0.4).refreshBody();
            platforms.create(3350, 1300, "ground2").setScale(0.4).refreshBody();
            platforms.create(3425, 1300, "ground2").setScale(0.4).refreshBody();
            platforms.create(3500, 1300, "ground2").setScale(0.4).refreshBody();
            platforms.create(3675, 1300, "ground2").setScale(0.4).refreshBody();
            platforms.create(3725, 1300, "ground2").setScale(0.4).refreshBody();
            platforms.create(3800, 1300, "ground2").setScale(0.4).refreshBody();
            platforms.create(3875, 1300, "ground2").setScale(0.4).refreshBody();
            platforms.create(3950, 1300, "ground2").setScale(0.4).refreshBody();
            //right side (done)
            platforms.create(4000, 650, "ground2").setScale(0.4).refreshBody();
            platforms.create(4000, 725, "ground2").setScale(0.4).refreshBody();
            platforms.create(4000, 800, "ground2").setScale(0.4).refreshBody();
            platforms.create(4000, 875, "ground2").setScale(0.4).refreshBody();
            platforms.create(4000, 925, "ground2").setScale(0.4).refreshBody();
            platforms.create(4000, 1000, "ground2").setScale(0.4).refreshBody();
            platforms.create(4000, 1050, "ground2").setScale(0.4).refreshBody();
            platforms.create(4000, 1100, "ground2").setScale(0.4).refreshBody();
            platforms.create(4000, 1175, "ground2").setScale(0.4).refreshBody();
            platforms.create(4000, 1250, "ground2").setScale(0.4).refreshBody();
            platforms.create(4000, 1325, "ground2").setScale(0.4).refreshBody();
            //right side room #2 (5,3)
            //floor
            platforms.create(3200, 1950, "ground2").setScale(0.4).refreshBody();
            platforms.create(3275, 1950, "ground2").setScale(0.4).refreshBody();
            platforms.create(3350, 1950, "ground2").setScale(0.4).refreshBody();
            platforms.create(3400, 1950, "ground2").setScale(0.4).refreshBody();
            platforms.create(3475, 1950, "ground2").setScale(0.4).refreshBody();
            platforms.create(3675, 1950, "ground2").setScale(0.4).refreshBody();
            platforms.create(3725, 1950, "ground2").setScale(0.4).refreshBody();
            platforms.create(3800, 1950, "ground2").setScale(0.4).refreshBody();
            platforms.create(3875, 1950, "ground2").setScale(0.4).refreshBody();
            platforms.create(3950, 1950, "ground2").setScale(0.4).refreshBody();
            //right side (done)
            platforms.create(4000, 1300, "ground2").setScale(0.4).refreshBody();
            platforms.create(4000, 1375, "ground2").setScale(0.4).refreshBody();
            platforms.create(4000, 1450, "ground2").setScale(0.4).refreshBody();
            platforms.create(4000, 1525, "ground2").setScale(0.4).refreshBody();
            platforms.create(4000, 1575, "ground2").setScale(0.4).refreshBody();
            platforms.create(4000, 1650, "ground2").setScale(0.4).refreshBody();
            platforms.create(4000, 1700, "ground2").setScale(0.4).refreshBody();
            platforms.create(4000, 1750, "ground2").setScale(0.4).refreshBody();
            platforms.create(4000, 1825, "ground2").setScale(0.4).refreshBody();
            platforms.create(4000, 1900, "ground2").setScale(0.4).refreshBody();
            platforms.create(4000, 1975, "ground2").setScale(0.4).refreshBody();
            //right side room #3 (5,4)
            //floor
            platforms.create(3200, 2600, "ground2").setScale(0.4).refreshBody();
            platforms.create(3275, 2600, "ground2").setScale(0.4).refreshBody();
            platforms.create(3350, 2600, "ground2").setScale(0.4).refreshBody();
            platforms.create(3425, 2600, "ground2").setScale(0.4).refreshBody();
            platforms.create(3500, 2600, "ground2").setScale(0.4).refreshBody();
            platforms.create(3675, 2600, "ground2").setScale(0.4).refreshBody();
            platforms.create(3725, 2600, "ground2").setScale(0.4).refreshBody();
            platforms.create(3800, 2600, "ground2").setScale(0.4).refreshBody();
            platforms.create(3875, 2600, "ground2").setScale(0.4).refreshBody();
            platforms.create(3950, 2600, "ground2").setScale(0.4).refreshBody();
            //right side (done)
            platforms.create(4000, 1950, "ground2").setScale(0.4).refreshBody();
            platforms.create(4000, 2025, "ground2").setScale(0.4).refreshBody();
            platforms.create(4000, 2100, "ground2").setScale(0.4).refreshBody();
            platforms.create(4000, 2175, "ground2").setScale(0.4).refreshBody();
            platforms.create(4000, 2225, "ground2").setScale(0.4).refreshBody();
            platforms.create(4000, 2300, "ground2").setScale(0.4).refreshBody();
            platforms.create(4000, 2350, "ground2").setScale(0.4).refreshBody();
            platforms.create(4000, 2400, "ground2").setScale(0.4).refreshBody();
            platforms.create(4000, 2475, "ground2").setScale(0.4).refreshBody();
            platforms.create(4000, 2550, "ground2").setScale(0.4).refreshBody();
            platforms.create(4000, 2625, "ground2").setScale(0.4).refreshBody();
            //right side room #1 (4,2)
            //floor
            platforms.create(2400, 1300, "ground2").setScale(0.4).refreshBody();
            ...
            platforms.create(3075, 1300, "ground2").setScale(0.4).refreshBody();
            platforms.create(3150, 1300, "ground2").setScale(0.4).refreshBody();
            //right side (done)
            platforms.create(3200, 650, "ground2").setScale(0.4).refreshBody();
            platforms.create(3200, 725, "ground2").setScale(0.4).refreshBody();
            platforms.create(3200, 800, "ground2").setScale(0.4).refreshBody();
            platforms.create(3200, 875, "ground2").setScale(0.4).refreshBody();
            platforms.create(3200, 925, "ground2").setScale(0.4).refreshBody();
            platforms.create(3200, 1000, "ground2").setScale(0.4).refreshBody();
            platforms.create(3200, 1050, "ground2").setScale(0.4).refreshBody();
            platforms.create(3200, 1100, "ground2").setScale(0.4).refreshBody();
            platforms.create(3200, 1175, "ground2").setScale(0.4).refreshBody();
            platforms.create(3200, 1250, "ground2").setScale(0.4).refreshBody();
            platforms.create(3200, 1325, "ground2").setScale(0.4).refreshBody();
            //right side room #2 (4,3)
            //floor
            platforms.create(2400, 1950, "ground2").setScale(0.4).refreshBody();
            ...
            platforms.create(3075, 1950, "ground2").setScale(0.4).refreshBody();
            platforms.create(3150, 1950, "ground2").setScale(0.4).refreshBody();
            //right side (done)
            platforms.create(3200, 1300, "ground2").setScale(0.4).refreshBody();
            platforms.create(3200, 1375, "ground2").setScale(0.4).refreshBody();
            platforms.create(3200, 1450, "ground2").setScale(0.4).refreshBody();
            platforms.create(3200, 1525, "ground2").setScale(0.4).refreshBody();
            platforms.create(3200, 1575, "ground2").setScale(0.4).refreshBody();
            platforms.create(3200, 1750, "ground2").setScale(0.4).refreshBody();
            platforms.create(3200, 1825, "ground2").setScale(0.4).refreshBody();
            platforms.create(3200, 1900, "ground2").setScale(0.4).refreshBody();
            platforms.create(3200, 1975, "ground2").setScale(0.4).refreshBody();
            //right side room #3 (4,4)
            //floor
            platforms.create(2400, 2600, "ground2").setScale(0.4).refreshBody();
            platforms.create(2475, 2600, "ground2").setScale(0.4).refreshBody();
            platforms.create(2550, 2600, "ground2").setScale(0.4).refreshBody();
            platforms.create(2625, 2600, "ground2").setScale(0.4).refreshBody();
            platforms.create(2700, 2600, "ground2").setScale(0.4).refreshBody();
            platforms.create(2875, 2600, "ground2").setScale(0.4).refreshBody();
            platforms.create(2925, 2600, "ground2").setScale(0.4).refreshBody();
            platforms.create(3000, 2600, "ground2").setScale(0.4).refreshBody();
            platforms.create(3075, 2600, "ground2").setScale(0.4).refreshBody();
            platforms.create(3150, 2600, "ground2").setScale(0.4).refreshBody();
            //right side (done)
            platforms.create(3200, 1950, "ground2").setScale(0.4).refreshBody();
            platforms.create(3200, 2025, "ground2").setScale(0.4).refreshBody();
            platforms.create(3200, 2100, "ground2").setScale(0.4).refreshBody();
            platforms.create(3200, 2175, "ground2").setScale(0.4).refreshBody();
            platforms.create(3200, 2225, "ground2").setScale(0.4).refreshBody();
            platforms.create(3200, 2300, "ground2").setScale(0.4).refreshBody();
            platforms.create(3200, 2350, "ground2").setScale(0.4).refreshBody();
            platforms.create(3200, 2400, "ground2").setScale(0.4).refreshBody();
            platforms.create(3200, 2475, "ground2").setScale(0.4).refreshBody();
            platforms.create(3200, 2550, "ground2").setScale(0.4).refreshBody();
            platforms.create(3200, 2625, "ground2").setScale(0.4).refreshBody();
            //right side room #1 (3,2)
            //floor
            platforms.create(1600, 1300, "ground2").setScale(0.4).refreshBody();
            platforms.create(1675, 1300, "ground2").setScale(0.4).refreshBody();
            platforms.create(1750, 1300, "ground2").setScale(0.4).refreshBody();
            platforms.create(1825, 1300, "ground2").setScale(0.4).refreshBody();
            platforms.create(1900, 1300, "ground2").setScale(0.4).refreshBody();
            platforms.create(2075, 1300, "ground2").setScale(0.4).refreshBody();
            platforms.create(2125, 1300, "ground2").setScale(0.4).refreshBody();
            platforms.create(2200, 1300, "ground2").setScale(0.4).refreshBody();
            platforms.create(2275, 1300, "ground2").setScale(0.4).refreshBody();
            platforms.create(2350, 1300, "ground2").setScale(0.4).refreshBody();
            //right side (done)
            platforms.create(2400, 650, "ground2").setScale(0.4).refreshBody();
            platforms.create(2400, 725, "ground2").setScale(0.4).refreshBody();
            platforms.create(2400, 800, "ground2").setScale(0.4).refreshBody();
            platforms.create(2400, 875, "ground2").setScale(0.4).refreshBody();
            platforms.create(2400, 925, "ground2").setScale(0.4).refreshBody();
            platforms.create(2400, 1100, "ground2").setScale(0.4).refreshBody();
            platforms.create(2400, 1175, "ground2").setScale(0.4).refreshBody();
            platforms.create(2400, 1250, "ground2").setScale(0.4).refreshBody();
            platforms.create(2400, 1325, "ground2").setScale(0.4).refreshBody();
            //right side room #2 (3,3) *********Make Hidden door in here ***********
            //floor
            platforms.create(1600, 1950, "ground2").setScale(0.4).refreshBody();
            ...
            platforms.create(2125, 1950, "ground2").setScale(0.4).refreshBody();
            platforms.create(2200, 1950, "ground2").setScale(0.4).refreshBody();
            platforms.create(2275, 1950, "ground2").setScale(0.4).refreshBody();
            platforms.create(2350, 1950, "ground2").setScale(0.4).refreshBody();
            //right side (done)
            platforms.create(2400, 1300, "ground2").setScale(0.4).refreshBody();
            platforms.create(2400, 1375, "ground2").setScale(0.4).refreshBody();
            platforms.create(2400, 1450, "ground2").setScale(0.4).refreshBody();
            platforms.create(2400, 1525, "ground2").setScale(0.4).refreshBody();
            ...
            platforms.create(2275, 2600, "ground2").setScale(0.4).refreshBody();
            platforms.create(2350, 2600, "ground2").setScale(0.4).refreshBody();
            //right side (done)
            platforms.create(2400, 1950, "ground2").setScale(0.4).refreshBody();
            platforms.create(2400, 2025, "ground2").setScale(0.4).refreshBody();
            platforms.create(2400, 2100, "ground2").setScale(0.4).refreshBody();
            platforms.create(2400, 2175, "ground2").setScale(0.4).refreshBody();
            platforms.create(2400, 2350, "ground2").setScale(0.4).refreshBody();
            platforms.create(2400, 2400, "ground2").setScale(0.4).refreshBody();
            platforms.create(2400, 2475, "ground2").setScale(0.4).refreshBody();
            platforms.create(2400, 2550, "ground2").setScale(0.4).refreshBody();
            platforms.create(2400, 2625, "ground2").setScale(0.4).refreshBody();
            //right side room #1 (2,2)
            //floor
            platforms.create(800, 1300, "ground2").setScale(0.4).refreshBody();
            platforms.create(875, 1300, "ground2").setScale(0.4).refreshBody();
            platforms.create(950, 1300, "ground2").setScale(0.4).refreshBody();
            platforms.create(1025, 1300, "ground2").setScale(0.4).refreshBody();
            platforms.create(1100, 1300, "ground2").setScale(0.4).refreshBody();
            platforms.create(1275, 1300, "ground2").setScale(0.4).refreshBody();
            platforms.create(1325, 1300, "ground2").setScale(0.4).refreshBody();
            platforms.create(1400, 1300, "ground2").setScale(0.4).refreshBody();
            platforms.create(1475, 1300, "ground2").setScale(0.4).refreshBody();
            platforms.create(1550, 1300, "ground2").setScale(0.4).refreshBody();
            //right side (done)
            platforms.create(1600, 650, "ground2").setScale(0.4).refreshBody();
            platforms.create(1600, 725, "ground2").setScale(0.4).refreshBody();
            platforms.create(1600, 800, "ground2").setScale(0.4).refreshBody();
            platforms.create(1600, 875, "ground2").setScale(0.4).refreshBody();
            platforms.create(1600, 925, "ground2").setScale(0.4).refreshBody();
            platforms.create(1600, 1000, "ground2").setScale(0.4).refreshBody();
            platforms.create(1600, 1050, "ground2").setScale(0.4).refreshBody();
            platforms.create(1600, 1100, "ground2").setScale(0.4).refreshBody();
            platforms.create(1600, 1175, "ground2").setScale(0.4).refreshBody();
            platforms.create(1600, 1250, "ground2").setScale(0.4).refreshBody();
            platforms.create(1600, 1325, "ground2").setScale(0.4).refreshBody();
            ...
            platforms.create(1475, 1950, "ground2").setScale(0.4).refreshBody();
            platforms.create(1550, 1950, "ground2").setScale(0.4).refreshBody();
            //right side (done)
            platforms.create(1600, 1300, "ground2").setScale(0.4).refreshBody();
            platforms.create(1600, 1375, "ground2").setScale(0.4).refreshBody();
            platforms.create(1600, 1450, "ground2").setScale(0.4).refreshBody();
            platforms.create(1600, 1525, "ground2").setScale(0.4).refreshBody();
            platforms.create(1600, 1575, "ground2").setScale(0.4).refreshBody();
            platforms.create(1600, 1650, "ground2").setScale(0.4).refreshBody();
            platforms.create(1600, 1700, "ground2").setScale(0.4).refreshBody();
            platforms.create(1600, 1750, "ground2").setScale(0.4).refreshBody();
            platforms.create(1600, 1825, "ground2").setScale(0.4).refreshBody();
            platforms.create(1600, 1900, "ground2").setScale(0.4).refreshBody();
            platforms.create(1600, 1975, "ground2").setScale(0.4).refreshBody();
            ...
            platforms.create(1475, 2600, "ground2").setScale(0.4).refreshBody();
            platforms.create(1550, 2600, "ground2").setScale(0.4).refreshBody();
            //right side (done)
            platforms.create(1600, 1950, "ground2").setScale(0.4).refreshBody();
            platforms.create(1600, 2025, "ground2").setScale(0.4).refreshBody();
            platforms.create(1600, 2100, "ground2").setScale(0.4).refreshBody();
            platforms.create(1600, 2175, "ground2").setScale(0.4).refreshBody();
            platforms.create(1600, 2350, "ground2").setScale(0.4).refreshBody();
            platforms.create(1600, 2400, "ground2").setScale(0.4).refreshBody();
            platforms.create(1600, 2475, "ground2").setScale(0.4).refreshBody();
            platforms.create(1600, 2550, "ground2").setScale(0.4).refreshBody();
            platforms.create(1600, 2625, "ground2").setScale(0.4).refreshBody();
        }
        //creates player
        {
